...
if("TRUE" STREQUAL "TRUE")
  set(styx_SOURCE_PREFIX /mnt/data_main/CarND-Term3/CarND-Capstone/gitHub-repo/CarND-Capstone-System-Integration/ros/src/styx)
  set(styx_DEVEL_PREFIX /mnt/data_main/CarND-Term3/CarND-Capstone/gitHub-repo/CarND-Capstone-System-Integration/ros/devel)
  set(styx_INSTALL_PREFIX "")
  set(styx_PREFIX ${styx_DEVEL_PREFIX})
else()
  set(styx_SOURCE_PREFIX "")
  set(styx_DEVEL_PREFIX "")
  set(styx_INSTALL_PREFIX /mnt/data_main/CarND-Term3/CarND-Capstone/gitHub-repo/CarND-Capstone-System-Integration/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/data_main/CarND-Term3/CarND-Capstone/gitHub-repo/CarND-Capstone-System-Integration/ros/src/styx/${idir}'.  ${_report}")
    endif()
